module.exports = async function (client) {
    const targetChannelId = '1380000252982984854'; // Deine Voice-Channel-ID
    ...
    // Speichert Originalnamen und Reihenfolge
    const originalNicknames = new Map(); // member.id => originalNickname
    const enteredOrder = []; // member.id[] (Reihenfolge des Beitritts)
...
// Hilfsfunktion zur Nummerierung
